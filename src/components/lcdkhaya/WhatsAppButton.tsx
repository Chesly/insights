...
export default function WhatsAppButton() {
  const message = encodeURIComponent("Hi LCD Khaya Driving School, I'd like to find out more about lessons.");
  return (
    <a
      href={`https://wa.me/${lcdKhayaConfig.contact.whatsapp}?text=${message}`}
      target="_blank"

...
import ContactForm from "@/components/timelinetravel/ContactForm";

export async function timelineTravelContactMetadata(): Promise<Metadata> {
  return { title: "Contact", description: `Get in touch with ${timelineTravelSiteConfig.name}.` };
}

export default async function TimelineTravelContactPage() {

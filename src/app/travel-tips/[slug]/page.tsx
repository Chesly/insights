...
import { getArticleBySlug, getRelatedArticles } from "@/lib/timelinetravel/articles";
import { getToursByIds } from "@/lib/timelinetravel/tours";
    ...
    <div className="container-page py-10">
      ...
      <div className="mt-8 grid gap-10 lg:grid-cols-[1fr_320px]">
        ...
        {/* Sidebar — Related Tours, then Related Articles. Same rail
            pattern as src/app/insights/[slug]/page.tsx, with "Related
            Products" swapped for "Related Tours" since this site sells
            tours, not digital downloads — same content-to-booking funnel
            the build spec asks for (a Kruger article links to Kruger
            tours). */}

...
export default async function CoffeePostPage({
  params
}: {
  params: Promise<{ slug: string }>;
}) {
  ...
  return (
    <div>
      ...
      {/* Featured image with the headline overlaid directly on it — same
          treatment as /insights so both sections read as one template. */}

    ...
    <div>
      ...
      <div className="container-page prose prose-lg mx-auto max-w-3xl py-16 dark:prose-invert">
        ...
        <p>
          ...
          an AI Creative Strategist and Digital Brand Specialist based in {siteConfig.contact.location},
          and the founder of Chesly.Tech Creative Studio and Digitalized Art (Pty) Ltd.
        </p>
        <p>

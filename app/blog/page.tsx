...
export default function BlogIndexPage() {
  ...
  return (
    <div className="container-page py-12">
      <h1 className="text-3xl font-bold text-navy dark:text-white">Articles</h1>
      <p className="mt-2 text-navy/60 dark:text-white/60">
        {posts.length} articles on AI, technology, SEO, GEO and South African business.
      </p>
